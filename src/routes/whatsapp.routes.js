...
import { loadSession, deleteSession } from "../services/sessionStore.js";
...
router.post("/send", protect, async (req, res) => {
  try {
    ...
    if (!client) return res.status(400).json({ message: "WhatsApp client not ready" });
